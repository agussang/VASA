...
angular.module('vasaApp')
  .controller('LabuhEditCtrl',['$scope', '$filter','$timeout', '$location', '$routeParams','BuildPDF','Notification','TarifLabuhDetail','AppParam','TarifLabuhAdd','TarifLabuhEdit','LoadingScreen',function ($scope, $filter, $timeout, $location, $routeParams,BuildPDF,Notification,TarifLabuhDetail,AppParam,TarifLabuhAdd,TarifLabuhEdit,LoadingScreen) {
  LoadingScreen.show();
  $scope.options = {
	    autoclose: true,
	    todayBtn: '',

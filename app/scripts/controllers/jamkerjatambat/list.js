...
angular.module('vasaApp')
    .controller('JamKerjaTambatListCtrl', ['$scope', '$location', '$PAGE_SIZE', 'JamKerjaTambatList', 'LoadingScreen', 'JamKerjaTambatDelete', 'KawasanPanduList', 'Notification', 'KawasanPanduLevelDuaList', 'UserRole', function($scope, $location, $PAGE_SIZE, JamKerjaTambatList, LoadingScreen, JamKerjaTambatDelete, KawasanPanduList, Notification, KawasanPanduLevelDuaList, UserRole) {
        LoadingScreen.show();
        ...
        $scope.deleteJamKerjaTambat = function(idData) {
            var checkDelete = confirm('Apakah anda ingin menghapus data?');
            if (checkDelete) {
                JamKerjaTambatDelete.delete({ id: idData }, function(response) {
